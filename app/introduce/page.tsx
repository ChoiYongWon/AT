  ...
  return (
    <>
      ...
      <div className={IntroduceLayoutStyle}>
            ...
            <span className={DescriptionStyle} style={{marginTop: "34px", fontSize: "16px"}}>2. 등록된 장소 탐색하기</span>
            ...
            <span className={DescriptionStyle} style={{marginTop: "44px", fontSize: "16px"}}>3. 지도 공유하기</span>
            <div className={TextWrapperStyle} style={{marginLeft: "24px", marginTop: "10px"}}>
